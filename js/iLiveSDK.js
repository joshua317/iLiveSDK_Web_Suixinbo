...
ILiveRender.prototype = {
    ...
    */
    ...
    /**
    * 视频帧截图.
    * @description 的当前画面进行截图保存到文件.
    * @param {string} filePath - 截图文件保存的路径.
    * @param {string} fileName - 截图文件保存的文件名.
    * @returns {boolean} 是否截图成功，true 是，false 否;
    */
    snapShot: function (filePath, fileName) {
        return this.render.snapShot(filePath, fileName);
    },
}
